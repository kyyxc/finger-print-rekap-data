        ...
        <div class="flex-shrink-0 mb-4">
            <div class="relative">
                ...
                <input type="text" id="search-admin" placeholder="Cari username admin..."
                    class="w-full sm:w-80 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-medium text-gray-800">admin1</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
