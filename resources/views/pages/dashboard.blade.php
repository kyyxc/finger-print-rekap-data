                    ...
                    <table id="attendanceTable" class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="table-row-hover bg-white hover:bg-red-50/50 transition-all duration-200"
                                data-search="{{ strtolower(($attendance->user->nis ?? '') . ' ' . ($attendance->user->nama ?? '') . ' ' . ($attendance->user->grade->name ?? '')) }}">
                                ...
                                <td class="py-2 px-2 sm:py-4 sm:px-6">
                                    <div class="flex flex-col gap-0.5">
                                        ...
                                        {{-- Show NIS & grade on mobile --}}
                                        <span class="text-[9px] text-gray-500 sm:hidden">{{ $attendance->user->nis ?? '-' }} • {{ $attendance->user->grade->name ?? '-' }}</span>
                                    </div>
                                </td>
                                <td class="py-2 px-2 sm:py-4 sm:px-6 hidden sm:table-cell">
                                    <span
